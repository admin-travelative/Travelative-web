    ...
    return (
        <div className="fixed bottom-6 right-6 z-50">
            ...
            <motion.div
                ...
                className="absolute bottom-16 right-0 bg-white rounded-2xl shadow-xl p-3 whitespace-nowrap text-sm font-semibold text-gray-700 border border-gray-100"
            >
            ...
            <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="relative flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-2xl shadow-green-300 text-white transition-colors duration-200"
