...
export default function PackageDetailClient({ pkg }) {
    ...
    // Safety check for weather icon mapping
    let WeatherIcon = Cloud;
    if (weather) {
        if (weather.icon === 'snowy') WeatherIcon = Snowflake;
        else if (weather.icon === 'rainy') WeatherIcon = CloudRain;
        else if (weather.icon === 'windy') WeatherIcon = Wind;
        else if (weather.icon === 'sunny') WeatherIcon = Sun;
    }
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
                                <div className="relative h-64 sm:h-80 md:h-[460px] rounded-3xl overflow-hidden shadow-xl bg-gray-100 flex flex-col items-center justify-center">
                                    {pkg.images?.[activeImage] || pkg.images?.[0] ? (
                                        <>
                                            <img
                                        ...
                                        <div className="flex flex-col items-center justify-center text-gray-400">
                                            ...
                                            <span className="text-lg font-semibold opacity-70">No Image available</span>
                                        </div>
                                    )}
                            ...
                            <div className="lg:sticky lg:top-24">
                                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
                                    ...
                                    <div className="p-5 space-y-4">
                                        ...
                                        <a
                                            href={`https://wa.me/919927716717?text=${encodeURIComponent(`Hi! I'm interested in the ${pkg.title} package (${pkg.duration}) at ${formatPrice(pkg.price)}/person. Please share more details.`)}`}
