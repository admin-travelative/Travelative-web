...
import { Clock, MapPin, Star, CheckCircle, XCircle, Hotel, Calendar, Users, ArrowLeft, TrendingUp, AlertCircle } from 'lucide-react';
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
                                <div className="relative h-80 md:h-[460px] rounded-3xl overflow-hidden shadow-xl">
                                    <img
                            ...
                            <div>
                                <div className="flex items-center gap-2 text-gray-500 text-sm mb-2">
                                    ...
                                    <span className="ml-3 px-2 py-0.5 bg-emerald-100 text-emerald-700 text-xs font-bold rounded-full">{pkg.category}</span>
                                </div>
                                ...
                                <div className="flex gap-1 border-b border-gray-200 mb-6">
                                    {['itinerary', 'hotels', 'inclusions'].map((tab) => (
                                        <button key={tab} onClick={() => setActiveTab(tab)}
                                            className={`px-5 py-3 font-semibold text-sm capitalize transition-all border-b-2 -mb-px ${activeTab === tab ? 'border-emerald-600 text-emerald-700' : 'border-transparent text-gray-500 hover:text-gray-800'}`}>
                            ...
                            <div className="sticky top-24">
                                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
                                    ...
                                    <div className="p-5 space-y-4">
                                        ...
                                        <a
                                            href={`https://wa.me/91XXXXXXXXXX?text=${encodeURIComponent(`Hi! I'm interested in the ${pkg.title} package (${pkg.duration}) at ${formatPrice(pkg.price)}/person. Please share more details.`)}`}
                                        ...
                                        <div className="space-y-2.5 pt-2 border-t border-gray-100">
                                            {[{ Icon: Calendar, text: pkg.duration }, { Icon: Users, text: 'Group & Private available' }, { Icon: Star, text: `Rated ${pkg.rating}/5 (${pkg.reviewCount} reviews)` }].map(({ Icon, text }, i) => (
                                                <div key={i} className="flex items-center gap-2 text-sm text-gray-500"><Icon className="w-4 h-4 text-emerald-500" />{text}</div>
                                            ))}
                                        </div>
                                    </div>
                                </motion.div>
