                ...
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white rounded-3xl p-5 sm:p-8 shadow-sm border border-gray-100">
                        ...
                        <div className="mt-8 p-6 bg-gradient-to-br from-ocean-50 to-emerald-50 rounded-2xl border border-emerald-100">
                            ...
                            <a href="https://wa.me/917088221122?text=Hi! I am looking for a custom travel itinerary." target="_blank" rel="noopener noreferrer" className="btn-primary w-full shadow-md text-sm">
                                Chat on WhatsApp
                            </a>
                        </div>
                    </div>
